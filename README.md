...
|[CPP_modules](https://github.com/MKKurbandibirov/CPP-Modules)|Several projects aimed at introducing the basics of ```C++```, ```OOP```, ```exceptions```, etc.|C++ std98, Makefile|More than one|<img width="146" alt="image" src="https://user-images.githubusercontent.com/74917681/191956793-719efcee-2a21-4c17-a770-caaa202b7c43.png">|
...
|[ft_containers](https://github.com/MKKurbandibirov/ft_containers)|The goal of the project is to implement basic `C++` containers such as `std::vector`, `std::stack`, `std::map`, `std::set`|C++, Makefile|[Subject](https://github.com/MKKurbandibirov/ft_containers/blob/master/Subject.pdf)|<img width="146" alt="image" src="https://user-images.githubusercontent.com/74917681/191956685-29529aa6-70d6-4ff4-a115-b437672b8284.png">|
