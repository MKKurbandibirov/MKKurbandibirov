...
|[ft_containers](https://github.com/MKKurbandibirov/ft_containers)|The goal of the project is to implement basic `C++` containers such as `std::vector`, `std::stack`, `std::map`, `std::set`|C++, CMake|[Subject](https://github.com/MKKurbandibirov/ft_containers/blob/master/Subject.pdf)|<img width="146" alt="image" src="https://user-images.githubusercontent.com/74917681/191956685-29529aa6-70d6-4ff4-a115-b437672b8284.png">|
